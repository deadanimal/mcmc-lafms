...
@Component({
  selector: "app-rollout-project-management",
  templateUrl: "./rollout-project-management.component.html",
  styleUrls: ["./rollout-project-management.component.scss"],
})
export class RolloutProjectManagementComponent implements OnInit {
  entries: number = 5;
  selected: any[] = [];
  temp = [];
  activeRow: any;
