...
export class OrganisationsComponent implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    // this.getCharts();
    this.OrganisationData.getAll().subscribe((res) => {
      this.listOrganisation = res;
      this.tableRows = [...res];

      console.log(this.tableRows);
      this.listOrganisation = this.tableRows.map((prop, key) => {
    ...
    this.addNewOrganisationForm = this.formBuilder.group({
  ...
  addNewOrganisation() {
    ...
    // this.successMessage();
    console.log(this.addNewOrganisationForm.value);
    this.OrganisationData.create(this.addNewOrganisationForm.value).subscribe(
      () => {
        // Success
  ...
  editOrganisationDetail() {
    ...
    console.log(this.editOrganisationForm.value);
    this.OrganisationData.update(
      this.editOrganisationForm.value.id,
      this.editOrganisationForm.value
    ).subscribe(
      () => {
        // Success
        // this.isLoading = false
  ...
  navigatePage(path: String, id) {
    ...
    console.log(id);
    console.log(path + "/" + id);
    if (path == "/admin//utility/organisations") {
      return this.router.navigate([path]);
    } else if (path == "/admin//utility/organisation-detail") {
      return this.router.navigate([path, id]);
    }
  }

  getOrganisation(id: string): Organisation[] {
    return this.listOrganisation.find((e) => e.id === id);
  }
