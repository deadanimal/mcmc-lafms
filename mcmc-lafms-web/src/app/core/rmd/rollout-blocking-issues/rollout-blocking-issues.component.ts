...
@Component({
  selector: "app-rollout-blocking-issues",
  templateUrl: "./rollout-blocking-issues.component.html",
  styleUrls: ["./rollout-blocking-issues.component.scss"],
})
export class RolloutBlockingIssuesComponent implements OnInit {
  entries: number = 5;
  selected: any[] = [];
  temp = [];
  activeRow: any;
  ...
  initChart() {
    let chart = am4core.create("chartdivbi", am4charts.XYChart);
